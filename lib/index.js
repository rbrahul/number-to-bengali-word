 ...
 * @return {String}
 */
var converToBengaliWord = (function (number) {
    'use strict';
    var gonona = {
        amount: null,
        numberFragements: {
        ...
        getAmountInWord: function (value) {
            ...
            //console.log('SEGMENT ARRAY',segmentArray)
        ...
        init: function (amount) {
            ...
            var fractionNumberInWord = this.getAmountInWord(this.numberFragements.fractionPart);
...
module.exports = converToBengaliWord;
